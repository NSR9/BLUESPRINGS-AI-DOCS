...
from settings import CORS_ORIGINS, MAX_OUTPUT_TOKENS, DEFAULT_PROVIDER, DEFAULT_MODEL, OLLAMA_BASE_URL
...
def provider_registry():
    ...
    try:
        ...
        pass
    if OLLAMA_BASE_URL:
        registry["ollama"] = OllamaProvider()  # BONUS
    return registry

@app.get("/models")
async def models():
    # Keep it simple; students can expand lists
    return {
        "openai": ["gpt-4o-mini", "gpt-4o-mini-translate"],
        "anthropic": ["claude-3-5-haiku"],
        "gemini": ["gemini-1.5-flash"],
        "ollama": ["llama3", "phi3", "qwen2"] if OLLAMA_BASE_URL else []
    }
